...
if __name__ == "__main__":
    ...
    uvicorn.run(
        app,
        host="0.0.0.0",  # Allow external connections for Android app
        port=PORT,  # Use environment variable for Railway deployment
        reload=RAILWAY_ENVIRONMENT == "development"  # Only reload in development
    )
